...
class MovieAllAdapterTvShow (
    val context: Context,
    var listData: ArrayList<CategoryContentModel> = ArrayList(), var type: String
) : RecyclerView.Adapter<MovieAllAdapterTvShow.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.row_movie_type, parent, false)
    ...
    private fun setRecyclerview(mHolder: MyViewHolder, myModel: ArrayList<CategoryModel>) {
        ...
        movieAllListAdapter!!.setOnItemClickListener(object :
            MovieAllListAdapter.OnItemClickListener {
