...
class ContinueWarchingMoviesAdapter(
    val context: Context
    /*var listData: ArrayList<ContinueWatchModel> = ArrayList()*/) : RecyclerView.Adapter<ContinueWarchingMoviesAdapter.MyViewHolder>() {
