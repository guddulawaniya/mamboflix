...
class TrendingNowHomeAdapter(
    val context: Context,
    var listData: ArrayList<TrendingModel> = ArrayList()) : RecyclerView.Adapter<TrendingNowHomeAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (model.only_content!=null){
            Glide.with(context)
                    .load(Uri.parse(model.only_content!!.image))
