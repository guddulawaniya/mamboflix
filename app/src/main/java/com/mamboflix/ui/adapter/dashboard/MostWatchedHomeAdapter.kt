...
class MostWatchedHomeAdapter(
    val context: Context,
    var listData: ArrayList<MostWatchedModel> = ArrayList()) : RecyclerView.Adapter<MostWatchedHomeAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (model.content!=null){
            Glide.with(context)
                .load(Uri.parse(model.content.image))
